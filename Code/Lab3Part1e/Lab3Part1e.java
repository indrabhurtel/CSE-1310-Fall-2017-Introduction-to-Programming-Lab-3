...
public class Lab3Part1e {
	...
	private static void processData(int index,String a1,String a2,String a3,String a4,int exactStartTime, int exactBreakStartTime,int exactBreakEndTime,int exactEndTime,double rate) {
		...
		double recStartTime = round(exactStartTime);
		double recBreakStartTime = round(exactBreakStartTime);
		double recBreakEndTime = round(exactBreakEndTime);
		double recEndTime = round(exactEndTime);
	...
	public static double round(int num) {
		int n = num % 100;
		if (n <= 15) {
			num = num / 100;
			num = num * 100+15;
